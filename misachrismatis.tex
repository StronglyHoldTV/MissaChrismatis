...
\newpage
\noindent\textcolor{red}{\textbf{Medzispev:}}
...
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    \item \uarc{Boh} vstá\udown{va} a jeho \uup{ne}priate\udown{lia} sa \uepi{tra}tia, \textbf{\textcolor{red}{\gresixstar}}\space 
    \\spred jeho tváre utekajú \uup{tí,} čo ho \udown{ne}ná\uepi{vi}dia. \textbf{\textcolor{red}{— \Rbar}}
    \item \uarc{A}le \udown{spra}vodliví sa môžu tešiť a \uup{ja}sať pred \udown{Bo}žou tvárou \textbf{\textcolor{red}{\gresixstar}}\space 
    \\a \uup{v ra}dos\udown{ti} sa \uepi{ve}seliť. \textbf{\textcolor{red}{— \Rbar}}
    \item \uarc{Chváľ}te \udown{Pá}na \uup{v je}\uarc{ho} \uepi{svä}tyni, \textbf{\textcolor{red}{\gresixstar}}
