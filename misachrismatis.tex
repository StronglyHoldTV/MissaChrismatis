...
\section*{Introit}
\normalsize
\hfill{\small hudba: L. Tomáško}\\
\small{text: RM 267}\hfill{\small úprava: A. Akimiak}
...
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    ...
    \item Mo\textbf{je} srdce prekypuje krásnymi slovami, \textcolor{red}{\textbf{\GreDagger}}
    \\svoje verše ve\textbf{nu}jem \underline{krá}ľo\textbf{vi.} \textbf{\textcolor{red}{\gresixstar}} 
    \\Môj \textbf{ja}zyk je ako pero \textbf{rých}lo\uarc{pis}ca. \textbf{\textcolor{red}{— \Rbar}}
    \item Ty \textbf{si} najkrajší z ľudských synov. \textbf{\textcolor{red}{\GreDagger}}\space 
    \\Z tvojich perí \textbf{ply}nie \underline{mi}lo\textbf{ta.} \textbf{\textcolor{red}{\gresixstar}} 
    \\Pre\textbf{to} ťa Boh po\textbf{žeh}nal \underline{na}veky. \textbf{\textcolor{red}{— \Rbar}}
    \item Ty \textbf{naj}mocnejší, pripáš \textbf{si} meč \underline{na} bed\textbf{rá;} \textbf{\textcolor{red}{\gresixstar}} 
    \\svo\textbf{ju} vele\textbf{bu} a \underline{dôs}tojnosť. \textbf{\textcolor{red}{— \Rbar}}
    \item Vo \textbf{svo}jej dôstojnosti šťastne vytiahni, nasadni na voz \textbf{\textcolor{red}{\GreDagger}}\space 
    \\a bojuj zapravdu, lásku a \textbf{spra}vod\underline{li}\textbf{vosť.} \textbf{\textcolor{red}{\gresixstar}} 
    \\Nech \textbf{ťa} tvoja pravica učí konať ú\textbf{žas}né \uarc{skut}ky. \textbf{\textcolor{red}{— \Rbar}}
    \item Tvo\textbf{je} ostré šípy \textbf{\textcolor{red}{\GreDagger}}\space 
    \\zasiahnu srdcia kráľových \textbf{ne}pria\underline{te}\textbf{ľov;} \textbf{\textcolor{red}{\gresixstar}} 
    \\pod\textbf{da}jú \textbf{sa} ti \underline{ná}rody. \textbf{\textcolor{red}{— \Rbar}}
    \item Tvoj \textbf{trón,} Bože, \textbf{tr}vá \underline{na}ve\textbf{ky} \textbf{\textcolor{red}{\gresixstar}} 
    \\a \textbf{žez}lo tvojho kráľovstva je žezlo \textbf{spra}\-vod\underline{li}vosti. \textbf{\textcolor{red}{— \Rbar}}
    \item Mi\textbf{lu}ješ spravodlivosť a nenávidíš neprávosť, \textbf{\textcolor{red}{\GreDagger}}\space 
    \\preto ťa Boh, tvoj Boh, pomazal o\textbf{le}jom \underline{ra}do\textbf{sti} \textbf{\textcolor{red}{\gresixstar}} 
    \\viac \textbf{a}ko \textbf{tvo}jich \uarc{dru}hov. \textbf{\textcolor{red}{— \Rbar}}
    \item Tvoj \textbf{o}dev vonia myrhou, alo\textbf{ou} a \underline{ka}si\textbf{ou} \textbf{\textcolor{red}{\gresixstar}} 
    \\a \textbf{roz}veseľuje ťa zvuk harfy z palácov zo \textbf{slo}no\uarc{vi}ny. \textbf{\textcolor{red}{— \Rbar}}
\end{enumerate}

\noindent\textcolor{red}{\textbf{HYMNA JUBILEA}}\\

{\small{text a hudba: J. Habovštiaková}\hfill{\small úprava: S. Šurina}\par}
...
\textbf{\textcolor{red}{\Vbar.}} 
Sláva Bohu na výsostiach...
\hfill{\small LS I 658}\par
{\normalsize \lilypondfile{./Noty/gloria.ly}}

\newpage
\noindent\textcolor{red}{\textbf{Žalm:}}\\
\textcolor{red}{\textbf{\Rbar .}}\hfill{\small Katarina vl.}\par
{\normalsize \lilypondfile{./Noty/zalm.ly}}
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    \item Našiel som svojho služobníka Dávida, \textbf{\textcolor{red}{\gresixstar}}\\
    pomazal som ho svojím svätým olejom. 
    \item Pevne ho bude držať moja ruka, \textbf{\textcolor{red}{\gresixstar}}\\
    a posilňovať moje rameno. \textcolor{red}{\textbf{\Rbar .}}
    \item S ním bude moja vernosť a milosť, \textbf{\textcolor{red}{\gresixstar}}\\
    a v mojom mene sa povznesie jeho moc. 
    \item On bude volať ku mne: „Ty si môj Otec, \textbf{\textcolor{red}{\gresixstar}}\\
    môj Boh a útočisťe mojej spásy.“ \textcolor{red}{\textbf{\Rbar .}}
\end{enumerate}

\noindent\textcolor{red}{\textbf{Verš pred evanjeliom:}}
\hfill{\small gregoriánsky I. tónus}\par
{\normalsize \lilypondfile{./Noty/aleluja.ly}}

\vspace{1em}
\noindent Duch Pána je nado mnou, \textbf{\textcolor{red}{\gresixstar}}
poslal ma hlásať radostnú zvesť \\chudobným

\newpage
\chapter{Obnovenie kňazských sľubov}
\annotation{\textbf{Odpovedajú len prítomní kňazi.}}\annotation{Po homílii sa biskup prihovorí takto alebo podobne:}
...
\newpage
\annotation{\textbf{Odpovedajú spoločne všetci prítomní:}}
...
\begin{center}
Pieseň zo San Damiána\\
\small{(františkánske pramene)}
\end{center}
{\small slov. text: Miro Tóth}\hfill{\small hudba: Riz Ortolani}\par
\noindent Prijmi, Pane, obetu, ktorú Ti tu skladám,\\
...
\noindent \textcolor{red}{\textbf{\Rbar :}} Všetkým nám, raz si dal, zákon svojej lásky.\\
Všetkých nás, máš tak rád, nech Ti spieva každý.
\vspace{0.5em}
\section*{JKS 244/4}
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    \setcounter{enumi}{3}
...
\\naším pápežom \textcolor{red}{M.}, s naším biskupom \textcolor{red}{M.}
...
\annotation{Trocha sa skloní. (koncelebranti Pánové slová vyslovujú s pravicou vystretou smerom k chlebu, ak je to vhodné)}
...
znova ju položí na paténu a pokľaknutím adoruje. Koncelebranti 
pri pozdvihovaní pozrú na hostiu a potom sa pri pokľaknutí hlavného celebranta hlboko uklonia.}
...
\noindent\hskip-0.2em\euch{\startletter{S}krze neho ty, Pane,\marginalia{\textcolor{red}{Hl}}
...
{\small text: LU s.1856}\hfill{\small hudba: Michael John Trotta}\\
\noindent{\small slov. text: Os. obrady s.12}
\begin{multicols}{2}
\RaggedRight
\noindent Ave verum Corpus natum\\
De Maria Virgine:\\
...
\noindent Zdrav buď, pravé telo Krista\\
...
\large
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    \item \textbf{Hostiu vítajme}, - tej manne česť dajme, - zástupov Pánovi - a kráľov Kráľovi. - Zdrav’ buď, ó, anjelský chlebe, - voláme vrúcne ku tebe, - [:predrahé telo a krv.:]
...
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    ...
    vzplanie láskou ich slovo, nech stvorí v ľudstve dušu krásnu. 
    \textbf{\textcolor{red}{— \Rbar}}
    ...
    zlými. \textbf{\textcolor{red}{— \Rbar}}
\end{enumerate}
\newpage
\section*{ANTIFÓNA NA JUBILEUM}
{\normalsize \lilypondfile{./Noty/jub2.ly}}
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    \item \uarc{Chváľ}te \udown{Pá}na \uup{v je}\uarc{ho} \uepi{svä}tyni, \textbf{\textcolor{red}{\gresixstar}} \marginalia{\textcolor{red}{Ž. 150}}
    \\chváľte ho \uup{na} jeho vzne\udown{še}nej \uepi{ob}lohe. \textbf{\textcolor{red}{— \Rbar}}
    \item \uarc{Chváľ}te \udown{ho} \uup{za} jeho \udown{či}ny \uepi{mo}hutné, \textbf{\textcolor{red}{\gresixstar}} 
    \\chváľte ho \uup{za} jeho nes\udown{mier}nu \uepi{ve}lebnosť. \textbf{\textcolor{red}{— \Rbar}}
    \item \uarc{Chváľ}te \udown{ho} \uup{zvu}\uarc{kom} \uepi{poľ}nice, \textbf{\textcolor{red}{\gresixstar}} 
    \\chváľte ho \uup{har}\udown{fou} a \uepi{ci}tarou. \textbf{\textcolor{red}{— \Rbar}}
    \item \uarc{Chváľ}te \udown{ho} \uup{bub}\udown{nom} a \uepi{tan}com, \textbf{\textcolor{red}{\gresixstar}} 
    \\chváľte ho \uup{lý}\udown{rou} a \uepi{fla}utou. \textbf{\textcolor{red}{— \Rbar}}
    \item \uarc{Chváľ}te \udown{ho} ľubozvučnými cimbalmi, 
    \\\uup{chváľ}te ho jasa\udown{vý}mi \uepi{cim}balmi; \textbf{\textcolor{red}{\gresixstar}} 
    \\všetko, čo dýcha, \uup{nech} \udown{chvá}li \uepi{Pá}na. \textbf{\textcolor{red}{— \Rbar}}
    \item \uarc{Slá}va \udown{Ot}cu i Synu \uup{i} \udown{Du}chu \uepi{Svä}tému. \textbf{\textcolor{red}{\gresixstar}}  
    \\Ako bolo na počiatku, tak nech je i teraz i vždycky \uup{i} na veky \udown{ve}kov. \uepi{A}men. \textbf{\textcolor{red}{— \Rbar}}
\end{enumerate}
\newpage
...
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    \item \textbf{V sedmobrežnom kruhu Ríma}, - kde sa Petra chrám vypína. - Z tisíc
...
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    \item \textbf{Ó, Mária bolestivá}, - naša ochrana, - slovenský náš národ volá: - Pros
...
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
    \item \textbf{Lásky svätej ohnisko}, - Srdce Boha Kráľa, - z oltára sa našich sŕdc - vznáša k tebe chvála! [:Božské Srdce, buď s nami, - kraľuj, panuj nad nami, - nech sa v našej rodine - život viery rozvinie.:]
...
Biskupský ceremoniár, tajomník diecézneho biskupa
\vfill
\noindent Sadzba:\\
Marek Villim\\
Ing. Jozef Pazúrik
...
v Spišskej Kapitule v Spišskom Podhradí 2026

\newpage
\thispagestyle{empty}
\begin{center}
    \includesvg[width=0.8\textwidth]{Logo2.svg}
\end{center}
