...
\usepackage[a5paper, marginparsep=3mm]{geometry}
\usepackage{graphicx}
%\usepackage{package}
...
\newcommand{\partheading}[1]{%
    \noindent\normalsize\textcolor{red}{\textmd{\uppercase{#1}}}
}
...
\newcommand*{\annotationcenter}[1]{
    \noindent\normalsize\begin{center}\textcolor{red}{#1}\end{center}\normalsize
}
...
\fancyhead[RO]{\bfseries\textcolor{red}{\leftmark} \hspace{2em} \thepage}
...
\begin{document}
    \begin{titlepage}
        \begin{center}
            ...
            \vspace*{0.5cm}
            \\ \includegraphics[width=5cm]{./misachrismatis.jpg}
            \vspace*{0.5cm}
...
\section*{Kyrie}
\lilypondfile{./Noty/kyrie.ly}

\section*{Oslavná pieseň - glória}
\lilypondfile{./Noty/gloria.ly}

\section*{Medzispev}
\lilypondfile{./Noty/zalm.ly}
\lilypondfile{./Noty/aleluja.ly}
...
\section*{Hymnus}
\lilypondfile{./Noty/vykupitel_prijmi.ly}
\begin{enumerate}[label=\color{red}\bfseries\theenumi.]
...
\marginalia[pos=left, style={\color{red}}]{Hl}
\euch{\startletter{T}eba teda, najláskavejší Otče,
...
\marginalia{\textcolor{red}{1k}}
\euch{\startletter{P}amätaj, Pane,
...
\\\euch{ \begin{center}VEZMITE A JEDZTE Z NEHO VŠETCI,
\\LEBO TOTO JE MOJE TELO,
\\KTORÉ SA OBETUJE ZA VÁS.\end{center}}
...
\annotation{Príhovory „Pamätaj, Pane“ za zomrelých a „Aj nás, svojich
hriešnych služobníkov“ je vhodné zveriť jednému alebo dvom
koncelebrantom a každý sám prednesie tieto modlitby s rozopätými
rukami a zvýšeným hlasom.}
...
\annotation{Pri slovách „Aj nás, svojich hriešnych služobníkov“ všetci konce-
lebranti sa bijú v prsia.}
\\\marginalia{\textcolor{red}{k2}}\euch{\startletter{A}j nás, svojich hriešnych služobníkov,}
...
\section*{
    \begin{center}
        POŽEHNANIE OLEJA NA POMAZANIE CHORÝCH
    \end{center}
}
